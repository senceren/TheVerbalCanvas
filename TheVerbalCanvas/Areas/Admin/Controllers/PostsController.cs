...
using TheVerbalCanvas.Areas.Admin.Models;
...
namespace TheVerbalCanvas.Areas.Admin.Controllers
{
    ...
    public class PostsController : AdminBaseController
    {
        ...
        public async Task<IActionResult> Create(PostViewModel vm)
        {
            ...
            {
                // TODO: Resim varsa ve geçerliyse yükle ve ismini entitye aktar
                Post post = new Post()
                {
                    AuthorId = User.FindFirstValue(ClaimTypes.NameIdentifier)!,  // giriş yapmış kişinin ıdsi
                    Title = vm.Title,
                    Content = vm.Content,
